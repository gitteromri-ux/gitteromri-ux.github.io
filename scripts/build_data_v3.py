#!/usr/bin/env python3
"""
Build data.json for the goal-based dashboard.

Output structure:
- meta.Months / Schools / Languages / DateMin / DateMax
- facts: per (Month, School, Language, Rep, RankCalls, RankCont) records
       (compact keys: m,s,l,r,rc,ro,c,ct,o,a,v,u)
"""
